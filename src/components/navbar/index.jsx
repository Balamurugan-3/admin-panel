...
const Navbar = ({ onOpenSidenav }) => {
  ...
  return (
    <nav className="w-full z-40 flex items-center justify-between bg-white dark:bg-navy-800 px-4 py-2">
      {/* Left: Brand Name */}
      ...
      <div className="flex items-center gap-4">
        ...
        <Dropdown
          ...
          children={
            <div className="flex w-[360px] flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl dark:bg-navy-700 dark:text-white">
              ...
              <button className="flex w-full items-center">
                <div className="w-[85px] flex justify-center items-center rounded-xl bg-gradient-to-b from-brandLinear to-brand-500 py-4 text-2xl text-white">
                  🚀
                </div>
                <div className="ml-2 text-left">
                  <p className="text-base font-bold">New Update Available</p>
                  <p className="text-xs">Check the latest version now!</p>
                </div>
              </button>
            </div>
          }
          ...
          children={
            <div className="flex w-[350px] flex-col gap-2 rounded-[20px] bg-white p-4 shadow-xl dark:bg-navy-700 dark:text-white">
              ...
              <a
                ...
                className="bg-brand-500 text-white font-bold rounded-xl py-2 text-center hover:bg-brand-600"
              >
                Buy Horizon PRO
              </a>
              <a
                href="https://horizon-ui.com/docs"
                target="_blank"
                rel="noopener noreferrer"
                className="border dark:border-white/10 text-navy-700 dark:text-white font-bold rounded-xl py-2 text-center hover:bg-gray-200 dark:hover:bg-white/20"
              >
                See Documentation
              </a>
            </div>
          }
          classNames="py-2 top-6 right-0 w-max"
        />
        ...
        <Dropdown
          ...
          children={
            <div className="w-56 flex flex-col rounded-[20px] bg-white shadow-xl dark:bg-navy-700 dark:text-white">
              <div className="p-4">
              ...
              <div className="flex flex-col p-4">
                ...
                <a href="#" className="mt-2 text-sm hover:underline">
                  Newsletter Settings
                </a>
                <a
                  href="#"
